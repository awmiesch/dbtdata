...
bonds_by_maturity as (
    ...
    select  
        int_bonds.years_to_maturity_or_next_call,
    ...
    from int_bonds
    left join ref_maturity_categories on ref_maturity_categories.maturity_category_code = int_bonds.years_to_maturity_or_next_call
    group by int_bonds.years_to_maturity_or_next_call, ref_maturity_categories.maturity_category_desc
    order by 1
